...
const BankDetailsPage = () => {
  ...
  const { myEmployee, fetchMyEmployee, updateEmployee } = useEmployeeStore()
  ...
  const [myBankForm, setMyBankForm] = useState({
    ...
    branch_address: '123 Bank Street, New Delhi, Delhi 110001',
  ...
  return (
    <div className="max-w-4xl mx-auto">
      ...
      {activeTab === 'company-details' && user?.role === 'super_admin' && (
        <div>
          <div className="flex justify-between items-center mb-6">
            <h2 className="text-xl font-semibold text-foreground">College Bank Details</h2>
            <button
              onClick={() => setShowAddCompanyBank(true)}
              className="btn btn-primary"
            >
              Add College Bank Account
            </button>
          </div>
          ...
          {loading ? (
            ...
            <div className="text-center py-12 bg-card border border-border rounded-lg">
              <div className="text-6xl mb-4">🏢</div>
              <h3 className="text-lg font-semibold text-foreground mb-2">No College Bank Details</h3>
              <p className="text-muted-foreground mb-4">
                Add college bank details for payroll processing and payments.
              </p>
              <button
                onClick={() => setShowAddCompanyBank(true)}
                className="btn btn-primary"
              >
                Add First College Bank Account
              </button>
            </div>
          ) : (
            <div className="space-y-4">
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50">
          <div className="bg-card rounded-lg p-6 w-full max-w-3xl max-h-[90vh] overflow-y-auto">
            <h3 className="text-lg font-semibold text-foreground mb-4">
              Add College Bank Details
            </h3>

            <div className="space-y-6">
              {/* College Information */}
              <div className="space-y-4">
                <h4 className="font-medium text-foreground">College Information</h4>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    <label className="block text-sm font-medium text-foreground mb-2">
                      College Name *
                    ...
                    <input
                      ...
                      className="w-full px-3 py-2 border border-border rounded-md focus:outline-none focus:ring-2 focus:ring-primary focus:border-transparent bg-background text-foreground"
                      placeholder="Example College Name"
                    />
                  </div>
                  <div>
                    <label className="block text-sm font-medium text-foreground mb-2">
                    ...
                    <input
                      ...
                      className="w-full px-3 py-2 border border-border rounded-md focus:outline-none focus:ring-2 focus:ring-primary focus:border-transparent bg-background text-foreground"
                      placeholder="College name as per bank"
                    />
                  </div>
                  <div>
                    <label className="block text-sm font-medium text-foreground mb-2">
            ...
            <div className="flex space-x-3 mt-6">
              ...
              >
                {loading ? 'Adding...' : 'Add College Bank Details'}
              </button>
            </div>
          </div>
        </div>
