          ...
          <div>
            ...
            <div className="flex items-center space-x-4 mt-1 text-sm text-gray-500">
              ...
              <span className={`px-2 py-1 rounded-full text-xs ${problem.difficulty === 'easy' ? 'bg-green-100 text-green-800' :
                oblem.difficulty === 'medium' ? 'bg-yellow-100 text-yellow-800' :
                            ...
                            {submission.test_results && (
                              <div className="mt-2">
                                ...
                                <div className="w-full bg-gray-200 dark:bg-gray-700 rounded-full h-2 mt-1">
                                  <div
                                    className={`h-2 rounded-full ${submission.test_results.passed === submission.test_results.total
                                      ? 'bg-green-500'
                                      : 'bg-red-500'
                                      }`}
                    ...
                    {selectedSubmission.test_results.details.map((test) => (
                      <div key={test.test_number} className="border border-gray-200 dark:border-gray-700 rounded p-3">
                        <div className="flex items-center justify-between">
                          <div className="flex items-center space-x-3">
                            <span className={`w-6 h-6 rounded-full flex items-center justify-center text-xs font-medium ${test.status === 'passed'
