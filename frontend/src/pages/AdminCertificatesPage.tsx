        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50">
          <div className="bg-card rounded-lg p-6 w-full max-w-4xl max-h-[90vh] overflow-y-auto">
            ...
            <div className="bg-gray-100 rounded-lg p-8 mb-6 flex items-center justify-center min-h-96">
              <div className="bg-white shadow-lg rounded border-8 border-gray-400" style={{ width: '800px', height: '600px' }}>
                {previewTemplate.background_url ? (
                  <div className="relative w-full h-full" style={{ backgroundImage: `url(${previewTemplate.background_url})`, backgroundSize: 'cover', backgroundPosition: 'center' }}>
                    <div className="absolute inset-0 flex flex-col items-center justify-center text-center p-8">
                      {previewTemplate.logo_url && (
                        <img src={previewTemplate.logo_url} alt="Logo" className="h-20 mb-8" />
                      )}
                      <h2 className="text-4xl font-bold text-gray-800 mb-4">Certificate of Achievement</h2>
                      <p className="text-2xl text-gray-700 mb-6">{previewTemplate.name}</p>
                      <div className="text-sm text-gray-600">
                        <p>This is a preview of your certificate template</p>
                      </div>
                      {previewTemplate.watermark_url && (
                        <img src={previewTemplate.watermark_url} alt="Watermark" className="absolute opacity-20 h-32" />
                      )}
                    </div>
                  </div>
                ) : (
                  <div className="w-full h-full flex flex-col items-center justify-center bg-gradient-to-br from-blue-50 to-indigo-50 p-8">
                    ...
                    <div className="text-center text-gray-600 mb-8">
                      ...
                      <p className="text-sm">This certificate will be awarded to learners upon course completion</p>
                    </div>
                    <div className="flex gap-16 text-center text-sm text-gray-600 mt-12">
                      <div>
                        <p className="font-semibold text-gray-700">Learner Name</p>
                        <p className="border-t border-gray-400 mt-2 pt-2">_____________________</p>
                      </div>
                      <div>
            ...
            <div className="text-sm text-muted-foreground mb-6 bg-gray-50 p-4 rounded">
              <p><strong>Template Name:</strong> {previewTemplate.name}</p>
              {previewTemplate.description && <p><strong>Description:</strong> {previewTemplate.description}</p>}
              <p><strong>Status:</strong> {previewTemplate.is_active ? 'Active' : 'Inactive'} {previewTemplate.is_default && '(Default)'}</p>
            </div>
