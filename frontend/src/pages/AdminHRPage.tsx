    ...
    <div className="max-w-7xl mx-auto">
      ...
      <div className="flex space-x-1 mb-6">
        ...
        <button
          ...
          className={`px-4 py-2 text-sm font-medium rounded-lg transition-colors ${activeTab === 'payroll'
              ? 'bg-primary text-primary-foreground'
              : 'bg-card text-muted-foreground hover:text-foreground'
            }`}
        >
        ...
        <button
          ...
          className={`px-4 py-2 text-sm font-medium rounded-lg transition-colors ${activeTab === 'banking'
              ? 'bg-primary text-primary-foreground'
              : 'bg-card text-muted-foreground hover:text-foreground'
            }`}
        >
